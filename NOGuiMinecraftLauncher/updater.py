...
# Остальные импорты, общие для обеих версий (requests, threading и т.д.)

# ================= ТВОЙ КОД GUI =================
def run_gui():
    # Скроем консольное окно (только если это Windows и мы не в консольном режиме)
    if sys.platform == 'win32':
        ctypes.windll.user32.ShowWindow(ctypes.windll.kernel32.GetConsoleWindow(), 0)

    # Здесь код твоего GUI из sync_mods_config.py (класс UpdaterApp и т.д.)
    app = UpdaterApp()   # твой главный класс
    app.mainloop()
...
def run_console():
    ...
    def sync_mods(minecraft_dir, public_url):https://www.google.com/search?q=%D0%A1%D0%B4%D0%B5%D0%BB%D0%B0%D1%82%D1%8C+%D0%B8%D0%BA%D0%BE%D0%BD%D0%BA%D1%83+%D0%B8%D0%B7+%D1%84%D0%BE%D1%82%D0%BE+%D0%BA%D0%BE%D0%BD%D0%B2%D0%B5%D1%80%D1%82%D0%B0%D1%86%D0%B8%D1%8F&sourceid=chrome&ie=UTF-8
